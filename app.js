...
let img = `<img src="images/77358PICcwDkaw6e8z6ZE_PIC2018.png_300.png" alt="">`
food = {x: 6, y: 7};
...
function isCollide(snake) {
    ...
    if(snake[0].x >= 15 || snake[0].x <=0 || snake[0].y >= 17 || snake[0].y <=0){
        return true;
    }
...
function gameEngine(){
    ...
    if(isCollide(snakeArr)){
        ...
        musicSound.pause();
        inputDir =  {x: 0, y: 0}; 
        // swal("Game Lost!", "Press 'OK' and play again", "success");
        Swal.fire({
            title: 'Game Over!',
            text: 'Press "OK" and play again.',
            imageUrl: 'images/snake scrying.jpg',
            imageWidth: 250,
            imageHeight: 200,
            imageAlt: 'snake crying',
          })
